...
export default function SectionCard({sec, sections}) {
  ...
  function deleteSection(){
    window.addEventListener('click', (e)=>{
        ...
        console.log(e.target.closest(".sections_item"));
  ...
  return (
    <Card  sx={{ maxWidth: 500, minWidth: 250}} style={{borderRadius: "15px", position:'relative'}}>
      <CardContent style={{ }}>
        <Grid
          container
          direction="row"
        ...
        <CardActions>
          <Button size="small" style={{padding:'0', display:'block',  position:'absolute', top:'20px',right:'50px', minWidth:'24px',lineHeight:'24px', borderRadius:'50%', maxHeight:'24px'}}>
          ...
          <Button data-delete onClick={()=>{deleteSection()}} size="small" style={{padding:'0', display:'block',  position:'absolute', top:'20px',right:'20px', minWidth:'24px',lineHeight:'24px', borderRadius:'50%', maxHeight:'24px'}}>
